...
def test_web_buttons_and_action_messages_in_real_browser(tmp_path: Path) -> None:
    ...
    try:
        ...
        with sync_playwright() as pw:
            ...
            expect(page.get_by_text("Loop 队列")).to_be_visible()
            ...
            expect(page.get_by_text("Demo simulated session").first).to_be_visible()
            expect(page.get_by_text("Planner").first).to_be_visible()
            expect(page.get_by_text("Worker").first).to_be_visible()
            expect(page.get_by_text("Judge").first).to_be_visible()
...
""".lstrip(),
            ...
            loop_controls = page.get_by_label("Loop controls")
